  ...
  <div class="container d-flex justify-content-center">
    <div class="col-lg-6 mt-2">
        ...
        <div class="card-body" id="tambah">
            ...
            <div class="col ">
              <table style="width:100%">
                ...
                <tr>
                  ...
                  <td style="text-align: right"><a href="{{ url('pemandu/detail/'.$pemandu->id_pemandu.'/tiket') }}">{{ $pemandu->nama_pemandu }}</a></td>
                </tr>
                @endforeach
              </table>
            </div>
          ...
          <div class="row notes">
            <div class="col text-center">
              ...
              <a href="{{ pengaturan('link_gmaps') }}" class="btn text-center btn-maps px-3">Direct Maps</a>
            </div>
          </div>
              ...
              <table style="width:100%">
                ...
                <tr>
                  ...
                  <td>sakawisata@gmail.com 
                    <br> 
                    <a href="{{ pengaturan('link_Wa') }}" style="text-decoration: none; color: #2e0a0c !important;">{{ pengaturan('notelp_saka') }}</a>
                  </td>
                </tr>
              </table>
            </div>
      ...
      <div class="row justify-content-center">
        <a target="_blank" href="{{ url('/member/e-tiket/cetak/'.$pemesanan->kode_pemesanan) }}" class="btn btn-success"><i class="fa fa-print"> Cetak</i></a>
      </div>
    </div>
  </div>
</div>

          ...
          <div class="col-10 p-0">
            <nav>
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Situs Kunjungan</li>
              </ol>
            </nav>
          </div>
        </div>
          ...
          <div class="col-lg-11 pl-lg-0">
            <div class="card card-situs">
              ...
              <div class="content-situs">
                <div class="col-sm-6 col-md-6 col-lg-8 mx-auto mb-3">
                  <div class="owl-carousel slider-situs owl-theme">
                    @foreach ($situs as $item)
                    <div class="item">
                      <a href="{{ url('situs/detail/'.$item->id_situs) }}">
                        <img src="{{ asset('/img/situs/'.$item->foto_situs) }}" class="d-block img-fluid foto-situs" alt="foto-situs" style="height: 100%; object-fit: cover;">
                        <div class="carousel-caption d-none d-md-block" id="situs-main">
                ...
                <div class="col-lg-8 mx-auto ">
                 <div class="row row-situs-item justify-content-center">
                  ...
                  <div class="row d-flex justify-content-center text-center">
                   <a class="event-all btn btn-all" href="{{ url('situs/all_situs') }}">Semua Situs &nbsp; <i class="fas fa-long-arrow-alt-right"></i> </a>
                  </div>
                </div>
              </div>
            </div>

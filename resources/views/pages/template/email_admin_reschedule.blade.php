								...
								<tr>
									<td>
										<p style="margin: 10px 10px 0">
											Kunjungan dengan ID <strong>#{{ $pemesanan->kode_kunjungan }}</strong> mengajukan <strong>reschedule jadwal</strong>. <br />
					...
					<tr>
						<td style="padding: 10px 20px 10px">
							...
							>
								...
								<tr>
                  <td style="width: 150px; padding-bottom: 5px">ID kunjungan</td>
									<td style="width: 10px; padding-bottom: 5px">:</td>
									<td style="padding-bottom: 5px">{{ $pemesanan->kode_kunjungan }}</td>
								</tr>
                <tr>
                  <td style="width: 150px; padding-bottom: 5px">Tanggal Reschedule</td>
                  <td style="width: 10px; padding-bottom: 5px">:</td>
                  <td style="padding-bottom: 5px"><?php  echo date("d M Y", strtotime( $reschedule->tanggal_reschedule))?></td>
                </tr>
								<tr>
									<td style="width: 150px; padding-bottom: 5px">Sesi Reschedule</td>
									<td style="width: 10px; padding-bottom: 5px">:</td>
									<td style="padding-bottom: 5px">{{ $reschedule->nama_sesi }}</td>
								</tr>
								<tr>
									<td>
					...
					<!-- keterangan -->
					<tr>
						<td style="padding: 5px 20px 20px">
							<table width="100%">
								<tr>
									<td align="center" style="padding: 10px; border-spacing: 0">
										<p
											...
											"
										>
										Klik tombol dibawah ini untuk <br> konfirmasi reschedule jadwal kunjungan wisatawan
										</p>
										<a
											href="{{ url('admin/pemesanan/reschedule/'.$pemesanan->id_pemesanan) }}"
											style="
												background-color: rgb(130, 204, 121); color: #fafafa; text-decoration: none; padding: 10px 15px; border-radius: 5px; font-weight: 400;
											"
											>Reschedule Kunjungan</a
										>
									</td>
								</tr>
							</table>
